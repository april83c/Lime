    ...
    override fun run() {
        ...
        if (timer == 0) {
            try {
                ...
                gamesPlayed.appendTextLine(Chat.colored("&a&lGames Played"))
                gamesPlayed.appendTextLine(Chat.guiLine)
                wins.appendTextLine(Chat.colored("&a&lWins"))
                wins.appendTextLine(Chat.guiLine)
                kills.appendTextLine(Chat.colored("&a&lKills"))
                kills.appendTextLine(Chat.guiLine)
                diamondsMined.appendTextLine(Chat.colored("&a&lDiamonds Mined"))
                diamondsMined.appendTextLine(Chat.guiLine)
                goldMined.appendTextLine(Chat.colored("&a&lGold Mined"))
                goldMined.appendTextLine(Chat.guiLine)
                gapplesEaten.appendTextLine(Chat.colored("&a&lGapples Eaten"))
                ...
                latestMatch.appendTextLine(Chat.colored("&a&lLatest Match"))
